...
public class MllpServerResource extends ExternalResource {
    ...
    /**
     * Set the modulus used to determine when to include the START_OF_BLOCK
     * portion of the MLLP Envelope.
     *
     * If this value is less than or equal to 0, the START_OF_BLOCK portion
     * of the MLLP Envelope will always be included.
     * If the value is 1, the START_OF_BLOCK portion of the MLLP Envelope will
     * never be included.
     * Otherwise, if the result of evaluating message count % value is greater
     * than 0, the START_OF_BLOCK portion of the MLLP Envelope will not be
     * included.  Effectively leaving the START_OF_BLOCK portion of the MLLP Envelope
